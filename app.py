...
def displayImg(path,Ox,newPhoto_label,lstNote_text, note,photos):
    ...
    lstNote_text[Ox-1] = tk.Entry( frame_images, textvariable=entryText, width=48 )
...
def export_excel_new():
    try:
        ...
        if num_of_file_path == 0:
            ...
            if len(list_img) > 0:
                default_name = 'Thông tin phân tích khuôn mặt'
...
label1 = tk.Label(frame_main, text="Danh sách ảnh khuôn mặt phân tích được", fg="blue")
